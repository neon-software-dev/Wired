...
#ifndef WIREDENGINE_WIREDGPUVK_SRC_UTIL_VULKANUTIL_H
#define WIREDENGINE_WIREDGPUVK_SRC_UTIL_VULKANUTIL_H

#include <vulkan/vulkan.h>

namespace Wired::GPU
{
    uint32_t GetVkFormatByteSize(VkFormat format)
    {
        uint32_t result = 0;
        switch (format) {
...
#endif //WIREDENGINE_WIREDGPUVK_SRC_UTIL_VULKANUTIL_H
