...
#ifndef WIREDENGINE_WIREDENGINE_SRC_MODEL_ASSIMPUTIL_H
#define WIREDENGINE_WIREDENGINE_SRC_MODEL_ASSIMPUTIL_H
...
static inline glm::vec4 ConvertToGLM(const aiColor4D& from)
{
    return {from.r, from.g, from.b, from.a};
}

static inline glm::vec3 ConvertToGLM(const aiColor3D& from)
{
...
#endif //WIREDENGINE_WIREDENGINE_SRC_MODEL_ASSIMPUTIL_H
